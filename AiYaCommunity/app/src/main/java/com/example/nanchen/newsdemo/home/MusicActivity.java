...
import com.example.nanchen.newsdemo.home.music.MusicList;
import com.example.nanchen.newsdemo.home.music.MusicService;
import com.example.nanchen.newsdemo.home.music.MusicUnit;
import com.example.nanchen.newsdemo.home.music.MyAdapter;

import java.text.SimpleDateFormat;
import java.util.List;

public class MusicActivity extends Activity implements android.view.View.OnClickListener, SeekBar.OnSeekBarChangeListener {

    private ImageButton left, play, next;
    private ImageButton model;
    private ListView music_list;
    private TextView duration,songName,singer;
    ...
    private AdapterView.OnItemClickListener oClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            songName.setText(oList.get(position).getName());
            singer.setText(oList.get(position).getAuthor());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        oList = MusicList.getMusicData(MusicActivity.this);
        mAdapter = new MyAdapter(oList, MusicActivity.this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.left:
                ...
                songName.setText(oList.get(index).getName());
                singer.setText(oList.get(index).getAuthor());
                break;
            case R.id.next:
                if (index == oList.size() - 1)
                    index = 0;
